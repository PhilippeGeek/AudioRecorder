    ...
    class saveThread extends Thread {
        ...
        public void run() {
            ...
            try {
               ...
               /* IMediaWriter writer = ToolFactory.makeWriter("test.mp3");

                IContainer ic = writer.getContainer();
                ic.open(out , writer.getContainer().getContainerFormat(), true, false);
                reader = ToolFactory.makeReader(ic);
